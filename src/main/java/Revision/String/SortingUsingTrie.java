...
public class SortingUsingTrie {
    ...
    private static void printSorted(String[] arr, int n) {
        Trie root = new Trie();
    ...
    private static void insert(Trie root, String str, int index){
        Trie node = root;
    ...
    private static boolean preorder(Trie node, String[] arr) {
        if (node == null) {
